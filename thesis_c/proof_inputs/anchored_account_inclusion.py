...
def build_anchored_keccak_account_inclusion_witness(
    ...
    account_public_inputs = {
        ...
        "leaf_value_commitment": public_inputs["leaf_value_commitment"],
    }
    ...
    witness = {
        ...
        "public_leaf_value_commitment": account_witness.pop("public_leaf_value_commitment"),
